                          ...
                          <div key={status} className="premium-card bg-white border border-slate-200 overflow-hidden">
                            ...
                            >
                              <div className="flex items-center gap-4">
                                <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold ${status === 'sakit' ? 'bg-blue-50 text-blue-600' :
                              ...
                              <div className="px-5 pb-4 flex flex-wrap gap-2">
                                {Object.keys(attendanceRecords)
                                  ...
                                  .map(id => {
                                    ...
                                    return (
                                      <span key={id} className={`px-3 py-1 rounded-full text-[10px] font-bold border flex items-center gap-2 ${status === 'sakit' ? 'bg-blue-50 border-blue-200 text-blue-700' :
                                    ...
                                    {filteredStudents.map(student => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`w-full p-3 rounded-xl flex items-center justify-between text-left transition-all border ${attendanceRecords[student.id] === status
                                        ...
                                        >
                                          <div className="flex items-center gap-3">
                                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold ${attendanceRecords[student.id] === status ? 'bg-white/20' : 'bg-slate-100 text-slate-400'
                                              }`}>
